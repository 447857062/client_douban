...
import deplink.com.douya.network.api.info.UrlGettable;
...
public class SimpleUser implements UrlGettable, Parcelable {
    ...
    public static SimpleUser fromFrodo(
            deplink.com.douya.network.api.info.frodo.SimpleUser frodoSimpleUser) {
    ...
    @SuppressWarnings("deprecation")
    public deplink.com.douya.network.api.info.frodo.SimpleUser toFrodo() {
        deplink.com.douya.network.api.info.frodo.SimpleUser simpleUser =
                new deplink.com.douya.network.api.info.frodo.SimpleUser();
