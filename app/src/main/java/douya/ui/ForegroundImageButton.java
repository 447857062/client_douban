...
public class ForegroundImageButton extends AppCompatImageButton {
    ...
    private ForegroundHelper mForegroundHelper = new ForegroundHelper(
            new ForegroundHelper.Delegate() {
                ...
                public void superSetForegroundGravity(int foregroundGravity) {
                    ForegroundImageButton.super.setForegroundGravity(foregroundGravity);
                }

                @Override
                public void superSetVisibility(int visibility) {
                    ForegroundImageButton.super.setVisibility(visibility);
                }
                ...
                public void superOnLayout(boolean changed, int left, int top, int right,
                                          int bottom) {
                    ForegroundImageButton.super.onLayout(changed, left, top, right, bottom);
                }

                @Override
                public void superOnSizeChanged(int w, int h, int oldw, int oldh) {
                    ForegroundImageButton.super.onSizeChanged(w, h, oldw, oldh);
                }
    ...
    public ForegroundImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
