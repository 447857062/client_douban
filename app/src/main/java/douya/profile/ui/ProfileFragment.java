...
import douya.profile.content.ProfileResource;
import douya.profile.util.ProfileUtils;
import douya.ui.ContentStateLayout;
...
public class ProfileFragment extends Fragment implements ProfileResource.Listener,
    ...
    /**
     * @deprecated Use {@link #newInstance(String, douya.network.api.info.apiv2.SimpleUser, User)} instead.
     */
