...
import douya.diary.content.UserDiaryListResource;
import douya.followship.content.FollowingListResource;
...
import douya.network.api.info.frodo.UserItems;
import douya.review.content.UserReviewListResource;
...
public class ProfileResource extends TargetedRetainedFragment implements UserResource.Listener,
    ...
    private douya.network.api.info.apiv2.SimpleUser mSimpleUser;
    ...
    private static ProfileResource newInstance(
            String userIdOrUid,
            douya.network.api.info.apiv2.SimpleUser simpleUser, User user) {
    ...
    public douya.network.api.info.apiv2.SimpleUser getSimpleUser() {
        // Can be called before onCreate() is called.
        ensureArguments();
        return mSimpleUser;
    }
