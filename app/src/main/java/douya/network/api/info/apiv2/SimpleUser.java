...
public class SimpleUser implements UrlGettable, Parcelable {
    ...
    public static SimpleUser fromFrodo(
            douya.network.api.info.frodo.SimpleUser frodoSimpleUser) {
    ...
    @SuppressWarnings("deprecation")
    public douya.network.api.info.frodo.SimpleUser toFrodo() {
        douya.network.api.info.frodo.SimpleUser simpleUser =
                new douya.network.api.info.frodo.SimpleUser();
