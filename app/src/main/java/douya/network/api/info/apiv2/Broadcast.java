...
import douya.network.api.info.frodo.TextEntity;
...
public class Broadcast implements Parcelable {
    ...
    public douya.network.api.info.frodo.Broadcast toFrodo() {
        douya.network.api.info.frodo.Broadcast broadcast =
                new douya.network.api.info.frodo.Broadcast();
