...
import douya.network.api.info.frodo.*;
...
public class Photo implements SizedImageItem, Parcelable {
    ...
    public ArrayList<douya.network.api.info.frodo.Comment> comments = new ArrayList<>();
    ...
    protected Photo(Parcel in) {
        ...
        comments = in.createTypedArrayList(douya.network.api.info.frodo.Comment.CREATOR);
