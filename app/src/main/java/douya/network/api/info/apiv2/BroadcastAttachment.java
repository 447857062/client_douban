...
import douya.network.api.info.frodo.SizedImage;
...
public class BroadcastAttachment implements Parcelable {
    ...
    public douya.network.api.info.frodo.BroadcastAttachment toFrodo(
            ArrayList<Photo> photos) {
        douya.network.api.info.frodo.BroadcastAttachment attachment =
                new douya.network.api.info.frodo.BroadcastAttachment();
        attachment.type = photos.size() > 0 ?
                douya.network.api.info.frodo.BroadcastAttachment.Type.IMAGES
                        .getApiString()
                : douya.network.api.info.frodo.BroadcastAttachment.Type.NORMAL
                        .getApiString();
        ...
        for (Photo photo : photos) {
            douya.network.api.info.frodo.BroadcastAttachment.ImageBlock.Image
                    image = new douya.network.api.info.frodo.BroadcastAttachment
                    .ImageBlock.Image();
