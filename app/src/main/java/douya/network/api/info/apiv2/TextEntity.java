...
public class TextEntity implements Parcelable {
    ...
    public douya.network.api.info.frodo.TextEntity toFrodo() {
        douya.network.api.info.frodo.TextEntity entity =
                new douya.network.api.info.frodo.TextEntity();
        entity.end = end;
        entity.start = start;
        entity.title = title;
        entity.uri = href;
    ...
    public static ArrayList<douya.network.api.info.frodo.TextEntity> toFrodo(
            ArrayList<TextEntity> entities) {
        ArrayList<douya.network.api.info.frodo.TextEntity> frodoEntities =
                new ArrayList<>();
