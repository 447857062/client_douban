...
import douya.network.api.info.frodo.DoumailThread;
import douya.network.api.info.frodo.DoumailThreadList;
...
public class ApiService {
    ...
    public interface LifeStreamService {
        ...
        @FormUrlEncoded
        ApiRequest<douya.network.api.info.apiv2.Broadcast> sendBroadcast(
                @Field("text") String text, @Field("image_urls") String imageUrls,
                @Field("rec_title") String linkTitle, @Field("rec_url") String linkUrl);

        @GET
        ApiRequest<List<douya.network.api.info.apiv2.Broadcast>>
        ...
        @FormUrlEncoded
        ApiRequest<douya.network.api.info.apiv2.Comment> sendBroadcastComment(
    ...
    public interface FrodoService {
        ...
        ApiRequest<douya.network.api.info.frodo.CommentList> getBroadcastCommentList(@Path("broadcastId") long broadcastId,
                                                                                     @Query("start") Integer start,
                                                                                     @Query("count") Integer count);
